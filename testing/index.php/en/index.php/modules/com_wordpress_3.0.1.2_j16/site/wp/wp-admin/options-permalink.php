...
if ( ! got_mod_rewrite() && ! $iis7_permalinks )
	$prefix = '/index.php';
/* rc_corephp - Commenting this out as I did for schema.php */
...
<?php /* rc_corephp - Added 1 == 2 so that this never executes - handled through Joomla */?>
<?php if ( 1 == 2 && !is_multisite() ) { ?>
