...
function wp_install( $blog_title, $user_name, $user_email, $public, $deprecated = '', $user_password = '' ) {
	...
	/* rc_corephp - Comment all this out as we create the user, basec on current logged in user */
	...
	if ( is_a( $user_id, 'WP_Error' ) ) {
		$message = 'Unable to create WP user based on current logged in Joomla user.';
	}
...
function wp_install_defaults($user_id) {
	...
	$default_links[] = array(	'link_url' => 'http://www.corephp.com/blog/',
								'link_name' => '\'corePHP\' Blog',
								'link_rss' => 'http://www.corephp.com/blog/feed/',
								'link_notes' => '');
