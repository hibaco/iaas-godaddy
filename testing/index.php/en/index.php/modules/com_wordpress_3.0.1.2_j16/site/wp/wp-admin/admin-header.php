...
<h1 id="site-heading" <?php echo $title_class ?>>
	<a href="<?php echo get_bloginfo( 'url' ); ?>" title="<?php esc_attr_e('Visit Site') ?>">
		<span id="site-title"><?php echo $blog_name ?></span>
		<?php /* rc_corephp - Added this to make sure people know how to get back to the site */ ?>
		<em id="site-visit-button"><?php _e('Visit Site') ?></em>
	</a>
