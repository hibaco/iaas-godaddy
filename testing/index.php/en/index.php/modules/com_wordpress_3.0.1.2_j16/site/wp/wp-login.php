...
/* rc_corephp - This makes Joomla's URLs and paths happy */
if ( false === strpos( $_SERVER['REQUEST_URI'], 'components/com_wordpress/wp' ) ) {
	// I am glad I only have to do this once
