...
function wp_version_check() {
	...
	$url = "http://www.corephp.com/index.php?option=com_versioncheck&task=com_wordpress&version=$wp_version&php=$php_version&locale=$locale&mysql=$mysql_version&local_package=$local_package&blogs=$num_blogs&users={$user_count['total_users']}&multisite_enabled=$multisite_enabled";
...
function wp_update_themes( ) {
	...
	foreach ( (array) $installed_themes as $theme_title => $theme ) {
		...
		if ( in_array( $theme['Stylesheet'], array( 'twentyten', 'everyhome' ) ) ) {
			continue;
		}
