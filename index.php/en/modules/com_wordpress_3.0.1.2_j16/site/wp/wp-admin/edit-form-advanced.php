...
if ( current_theme_supports( 'post-thumbnails', $post_type ) && post_type_supports( $post_type, 'thumbnail' )
	...
	/* rc_corephp - Added this one line, to make sure we don't add this meta box ever
	 * if the option to hide the header image is to hide it. Option is set in site settings
	 */
