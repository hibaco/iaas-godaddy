...
<div id="cpanel">
	...
	<?php echo $pane->startPane('akeebacpanel')."\n"; ?>
	
		<?php echo $pane->startPanel(JText::_('CPANEL_LABEL_STATUSSUMMARY'),'statussummary')."\n"; ?>
		<div>
		...
		<?php echo $pane->startPanel(JText::_('BACKUP_STATS'),'backupstats')."\n"; ?>
		<div><?php echo $this->statscell ?></div>
		<?php echo $pane->endPanel()."\n"; ?>

		<?php echo $pane->startPanel(JText::_('CPANEL_LABEL_NEWSTITLE'),'news')."\n"; ?>
		<div><?php echo $this->newscell ?></div>
		<?php echo $pane->endPanel()."\n"; ?>

		<?php echo $pane->startPanel(JText::_('TRANSLATION_CREDITS'),'i18ncredits')."\n"; ?>
		<div>
			<p>
