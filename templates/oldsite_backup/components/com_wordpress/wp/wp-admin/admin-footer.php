...
echo apply_filters( 'admin_footer_text', '<span id="footer-thankyou">' . __('Thank you for creating with <a href="http://wordpress.org/">WordPress</a>.').'</span> | '.__('<a href="http://codex.wordpress.org/">Documentation</a>').' | '.__('<a href="https://www.corephp.com/members/submitticket.php">Feedback</a>').' | '.__('<a href="http://www.corephp.com/" target="_blank">Integrated by \' corePHP \'</a>') ); ?>
</p>
